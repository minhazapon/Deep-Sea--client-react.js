...
const Pay = () => {
    ...
    return (
        <div className=" mb-20 mt-20 ml-10 mr-10 ">
        ...
        <div class="font-[sans-serif] bg-white p-4 lg:max-w-7xl max-w-xl mx-auto">
              <div class="grid lg:grid-cols-3 gap-10">
                <div class="lg:col-span-2 max-lg:order-1">
                  ...
                  <form onSubmit={onSubmit} class="mt-16 max-w-lg">
                    <h2 class="text-2xl font-extrabold text-gray-800 deep ">Payment method</h2>
        
                    <div class="grid gap-4 sm:grid-cols-2 mt-8">
                      <div class="flex items-center">
                        <input name="card" type="radio" class="w-5 h-5 cursor-pointer" id="card" checked />
                      ...
                      <div class="flex items-center">
                        <input name="paypal" type="radio" class="w-5 h-5 cursor-pointer" id="paypal" />
                    ...
                    <div class="grid gap-4 mt-8">
                      <input name="name" type="text" placeholder="Cardholder's Name"
                      ...
                      <div class="grid grid-cols-2 gap-6">
                        <input name="number1" type="number" placeholder="EXP."
                          class="px-4 py-3.5 bg-white text-gray-800 w-full text-sm border-b-2 focus:border-gray-800 outline-none" />
                        <input name="number2" type="number" placeholder="CVV"
                          class="px-4 py-3.5 bg-white text-gray-800 w-full text-sm border-b-2 focus:border-gray-800 outline-none" />
                      </div>
                    ...
                    <div class="flex flex-wrap gap-4 mt-8">
                      <input type="submit" class=" cursor-pointer deep min-w-[150px] px-6 py-3.5 text-sm bg-gray-800 text-white rounded-md hover:bg-[#111]" value="Payment" />
                    </div>
                  </form>
                </div>
