...
const ContactForm = () => {
    ...
    return (
        <div className=" mt-20 mb-20 ml-16 mr-16  flex justify-center">
            ...
            <div>
                <h2 class="text-cyan-400 deep text-3xl font-extrabold">Get In Touch</h2>
                <p class="text-sm text-gray-400 deep mt-4 leading-relaxed">Have a specific inquiry or looking to explore new opportunities? Our
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <input className="  cursor-pointer mt-8 flex items-center justify-center text-sm w-full rounded-md px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white " type="submit" value="Submit" />
                    </div>
                </form>

                <ul class="mt-4 flex flex-wrap justify-center gap-6">
                    <li class="flex items-center text-cyan-400">
                        ...
                        <a href="javascript:void(0)" class="text-sm ml-4">
                            <strong className=" deep ">Deep@Sea.com</strong>
                        </a>
                    </li>
                    <li class="flex items-center text-cyan-400">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='currentColor'
                        ...
                        <a href="javascript:void(0)" class="text-sm ml-4">
                            <strong className=" deep ">+158 996 888</strong>
                        </a>
                    </li>
                </ul>
            </div>
